...
import threeOrbitcontrols from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js/+esm'
...
//Controls
 const controls = new threeOrbitcontrols(camera, canvasa)
